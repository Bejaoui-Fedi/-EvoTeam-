...
#[Route('/user/exercice')]
final class UserExerciceController extends AbstractController
{
    // ──────────────────────────────────────────
    //  LISTE
    // ──────────────────────────────────────────
    #[Route('/', name: 'app_user_exercice_index', methods: ['GET'])]
    public function index(Request $request, ExerciceRepository $repository): Response
    {
        ...
        return $this->render('user_exercice/index.html.twig', [
            'exercices'  => $exercices,
            'search'     => $search,
    ...
    //  AJOUT
    // ──────────────────────────────────────────
    #[Route('/new', name: 'app_user_exercice_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $em, \App\Repository\ObjectifRepository $objectifRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($exercice->getObjectif()) {
                return $this->redirectToRoute('app_user_objectif_show', ['id' => $exercice->getObjectif()->getId()]);
            }

            return $this->redirectToRoute('app_user_exercice_index');
        }

        return $this->render('user_exercice/new.html.twig', [
    ...
    //  DÉTAIL
    // ──────────────────────────────────────────
    #[Route('/{id}', name: 'app_user_exercice_show', methods: ['GET'])]
    public function show(Exercice $exercice): Response
    {
        return $this->render('user_exercice/show.html.twig', [
            'exercice' => $exercice,
        ]);
    }
    ...
    //  MODIFICATION
    // ──────────────────────────────────────────
    #[Route('/{id}/edit', name: 'app_user_exercice_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Exercice $exercice, EntityManagerInterface $em): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_user_exercice_show', ['id' => $exercice->getId()]);
        }

        return $this->render('user_exercice/edit.html.twig', [
            'exercice' => $exercice,
            'form'     => $form->createView(),
        ]);
    }
    ...
    //  SUPPRESSION
    // ──────────────────────────────────────────
    #[Route('/{id}/delete', name: 'app_user_exercice_delete', methods: ['POST'])]
    ...
    //  EXPORT PDF
    // ──────────────────────────────────────────
    #[Route('/export/pdf', name: 'app_user_exercice_export_pdf', methods: ['GET'])]
    public function exportPdf(ExerciceRepository $repository): Response
    {
        ...
        $html = $this->renderView('user_exercice/pdf_report.html.twig', [
            'exercices' => $exercices,
            'date'      => new \DateTime(),
        ]);
